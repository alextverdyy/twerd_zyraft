...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHIELD_ZYRAFT_RIGHT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_OSKEY_DEFAULT_OS_WINDOWS, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_KSCAN_DEBOUNCE_RELEASE_MS, 5);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PROSPECTOR_STATUS_SCREEN_CLASSIC, 1);
